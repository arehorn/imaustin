        ...
        <form onSubmit={handleSubmit} className="relative">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
            <div>
              <label className="block text-[10px] font-bold tracking-[0.3em] uppercase mb-2 text-[#FF5A1F]" htmlFor="name">
                Name<span className="text-[#FF5A1F] ml-1" aria-hidden="true">*</span>
              </label>
              <input
                id="name"
                type="text"
            ...
            <div>
              <label className="block text-[10px] font-bold tracking-[0.3em] uppercase mb-2 text-[#FF5A1F]" htmlFor="email">
                Email<span className="text-[#FF5A1F] ml-1" aria-hidden="true">*</span>
              </label>
              <input
                id="email"
                type="email"
          ...
          <div className="mb-8">
            <label className="block text-[10px] font-bold tracking-[0.3em] uppercase mb-2 text-[#C9A86C]" htmlFor="message">
              Message<span className="text-[#FF5A1F] ml-1" aria-hidden="true">*</span>
            </label>
            <textarea
              id="message"
              required
          ...
          >
            {formState === "loading" ? (
              <>
                <svg aria-hidden="true" className="animate-spin -ml-1 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
