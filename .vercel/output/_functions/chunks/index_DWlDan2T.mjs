...
Let&apos;s Connect
</a> ${hero.resume_url && renderTemplate`<a${addAttribute(hero.resume_url, "href")} download class="px-8 py-4 rounded-2xl glass-card text-white font-bold tracking-wide hover:bg-white/10 transition-all inline-flex items-center gap-3 group"> <span class="material-symbols-outlined group-hover:translate-y-1 transition-transform text-[#00F2FF]">download</span>
Download CV
